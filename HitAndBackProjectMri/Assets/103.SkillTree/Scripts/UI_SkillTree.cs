...
public class UI_SkillTree : MonoBehaviour {
    ...
    public void SetPlayerSkills(PlayerSkills playerSkills) {
        ...
        skillButtonList.Add(new SkillButton(transform.Find("DashBtn"), playerSkills, PlayerSkills.SkillType.Earthshatter, skillLockedMaterial, skillUnlockableMaterial));
